...
# PARAMS
ENTITY_NAME = "ProductCategoryPositions"
MODEL = ProductCategoryPositions
ROUTE = "/productCategoryPositions"
END_POINT = "productCategoryPositions"
...
class ProductCategoryPositionsResource(Resource):
    def __init__(self):
...
class ProductCategoryPositionsListResource(Resource):
    def __init__(self):
        self.route = ROUTE
