from models.db_models.models import UserConfirmationCodes
...
#PARAMS
ENTITY_NAME = "User Confirmation Codes"
MODEL = UserConfirmationCodes
ROUTE ="/userConfirmationCodes"
END_POINT = "user-confirmation-codes"
...
class UserConfirmationCodesResource(Resource):
    def __init__(self):
...
class UserConfirmationCodesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
