from models.db_models.models import UserRoleRoutes
...
#PARAMS
ENTITY_NAME = "User Role Routes"
MODEL = UserRoleRoutes
ROUTE ="/userRoleRoutes"
END_POINT = "user-role-routes"
...
class UserRoleRoutesResource(Resource):
    def __init__(self):
...
class UserRoleRoutesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
