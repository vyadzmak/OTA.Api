...
output_fields = {
    ...
    'default_image_data':fields.Nested(default_image_data),
    'images_data':fields.Nested(default_image_data)
}
...
class BrandsResource(Resource):
    ...
    def get(self, id):
        ...
        if (entity.default_image_data.file_path!=None):
            entity.default_image_data.file_path=urllib.parse.urljoin(api_url, entity.default_image_data.file_path)

        if (entity.default_image_data.thumb_file_path!=None):
            entity.default_image_data.thumb_file_path=urllib.parse.urljoin(api_url, entity.default_image_data.thumb_file_path)

        if (entity.default_image_data.optimized_size_file_path!=None):
            entity.default_image_data.optimized_size_file_path=urllib.parse.urljoin(api_url, entity.default_image_data.optimized_size_file_path)
