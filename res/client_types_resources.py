from models.db_models.models import ClientTypes
...
#PARAMS
ENTITY_NAME = "Client Types"
MODEL = ClientTypes
ROUTE ="/clientTypes"
END_POINT = "client-types"
...
class ClientTypesResource(Resource):
    def __init__(self):
...
class ClientTypesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
