from models.db_models.models import OrderStates
...
#PARAMS
ENTITY_NAME = "Order States"
MODEL = OrderStates
ROUTE ="/orderStates"
END_POINT = "order-states"
...
class OrderStatesResource(Resource):
    def __init__(self):
...
class OrderStatesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
