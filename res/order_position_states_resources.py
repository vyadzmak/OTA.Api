from models.db_models.models import OrderPositionStates
...
#PARAMS
ENTITY_NAME = "Order Position States"
MODEL = OrderPositionStates
ROUTE ="/orderPositionStates"
END_POINT = "order-position-states"
...
class OrderPositionStatesResource(Resource):
    def __init__(self):
...
class OrderPositionStatesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
