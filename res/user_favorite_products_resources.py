...
#PARAMS
ENTITY_NAME = "User Favorite Products"
MODEL = UserFavoriteProducts
ROUTE ="/userFavoriteProducts"
END_POINT = "user-favorite-products"
...
class UserFavoriteProductsResource(Resource):
    def __init__(self):
...
class UserFavoriteProductsListResource(Resource):
    def __init__(self):
        self.route = ROUTE
