from models.db_models.models import UserCarts
...
#PARAMS
ENTITY_NAME = "User Carts"
MODEL = UserCarts
ROUTE ="/userCarts"
END_POINT = "user-carts"
...
class UserCartsResource(Resource):
    def __init__(self):
...
class UserCartsListResource(Resource):
    def __init__(self):
        self.route = ROUTE
