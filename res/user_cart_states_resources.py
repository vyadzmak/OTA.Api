from models.db_models.models import UserCartStates
...
#PARAMS
ENTITY_NAME = "User Cart States"
MODEL = UserCartStates
ROUTE ="/userCartStates"
END_POINT = "user-cart-states"
...
class UserCartStatesResource(Resource):
    def __init__(self):
...
class UserCartStatesListResource(Resource):
    def __init__(self):
        self.route = ROUTE
